const df_431_2 = new (require('@comunica/logger-void').LoggerVoid)();
...
const urn_comunica_default_extract_links_actors_quad_pattern = new (require('@comunica/actor-extract-links-quad-pattern').ActorExtractLinksQuadPattern)({
  'onlyVariables': true,
  'name': 'urn:comunica:default:extract-links/actors#quad-pattern',
...
const urn_comunica_default_Runner = (https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__2_0_0_components_ActorInit_jsonld_ActorInit_default_bus, [
  urn_comunica_default_extract_links_actors_quad_pattern,
